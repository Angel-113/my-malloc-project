...
void tree_test_performance(
    void) { /* This function intends to be sort of a heavy test */
...
static u64 get_rng64(void) { return ldexpl(pcg32_random_r(&my_rng), -32); }

static u32 get_rng32(void) { return pcg32_random_r(&my_rng); }
